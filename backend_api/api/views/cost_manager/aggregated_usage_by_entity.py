...
# Serializers
from ...serializers.usage import AggregatedUsageEntitySerializer
...
def aggregated_usage_by_entity(request):
  try:
    # get first filtered and then aggregated data
    aggregated_data = get_filtered_aggregated_data(request, "entity_pk")
  ...
  aggregated_data = aggregated_data[[
      "usage_time", "entity_pk", "entity_name"]]

  # serialize data into JSON
  serializer = AggregatedUsageEntitySerializer(
