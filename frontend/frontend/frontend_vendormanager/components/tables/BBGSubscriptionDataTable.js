...
import getSubscriptions from "../../api_utils/api_fetchers/getSubscriptions";

/* API MUTATION */
import deleteSubscription from "../../api_utils/api_mutators/delete/deleteSubscription";
...
export default function BBGAccountDataTable({
  ...
  const [DeleteModal, showDeleteModal] = useDeleteConfirmation(
    deleteSubscription, // Api call
    "Deleted Bloomberg Account Number successfully", // Success Notification Text
    ["Subscriptions", 1 /* Depth */], // Query to invalidate on success
